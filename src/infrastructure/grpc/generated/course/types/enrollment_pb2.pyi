...
class EnrollmentDetail(_message.Message):
    __slots__ = ("enrollmentId", "userId", "courseId", "progressPercent", "status", "enrolledAt", "sections")
    ...
    ENROLLEDAT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, enrollmentId: _Optional[str] = ..., userId: _Optional[str] = ..., courseId: _Optional[str] = ..., progressPercent: _Optional[int] = ..., status: _Optional[str] = ..., enrolledAt: _Optional[str] = ..., sections: _Optional[_Iterable[_Union[EnrollmentSection, _Mapping]]] = ...) -> None: ...

class EnrollmentSection(_message.Message):
    __slots__ = ("id", "title", "description", "order", "isPublished", "lessons", "quiz")
    ID_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ORDER_FIELD_NUMBER: _ClassVar[int]
    ISPUBLISHED_FIELD_NUMBER: _ClassVar[int]
    ...
    quiz: QuizProgress
    def __init__(self, id: _Optional[str] = ..., title: _Optional[str] = ..., description: _Optional[str] = ..., order: _Optional[int] = ..., isPublished: bool = ..., lessons: _Optional[_Iterable[_Union[LessonProgress, _Mapping]]] = ..., quiz: _Optional[_Union[QuizProgress, _Mapping]] = ...) -> None: ...

class LessonProgress(_message.Message):
    __slots__ = ("id", "title", "order", "duration", "completed", "completedAt")
    ID_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    ORDER_FIELD_NUMBER: _ClassVar[int]
    ...
    completed: bool
    completedAt: str
    def __init__(self, id: _Optional[str] = ..., title: _Optional[str] = ..., order: _Optional[int] = ..., duration: _Optional[int] = ..., completed: bool = ..., completedAt: _Optional[str] = ...) -> None: ...
...
class QuizQuestion(_message.Message):
    __slots__ = ("id", "requirePassingScore", "options", "timeLimit", "question", "type", "explanation", "score", "correctAnswer")
    ID_FIELD_NUMBER: _ClassVar[int]
    ...
    score: int
    correctAnswer: str
    def __init__(self, id: _Optional[str] = ..., requirePassingScore: bool = ..., options: _Optional[_Iterable[_Union[QuestionOption, _Mapping]]] = ..., timeLimit: _Optional[int] = ..., question: _Optional[str] = ..., type: _Optional[str] = ..., explanation: _Optional[str] = ..., score: _Optional[int] = ..., correctAnswer: _Optional[str] = ...) -> None: ...

class QuizProgress(_message.Message):
    __slots__ = ("id", "title", "description", "questions", "timeLimit", "requirePassingScore", "passingScore", "completed", "passed", "score", "completedAt")
    ID_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    score: int
    completedAt: str
    def __init__(self, id: _Optional[str] = ..., title: _Optional[str] = ..., description: _Optional[str] = ..., questions: _Optional[_Iterable[_Union[QuizQuestion, _Mapping]]] = ..., timeLimit: _Optional[int] = ..., requirePassingScore: bool = ..., passingScore: _Optional[int] = ..., completed: bool = ..., passed: bool = ..., score: _Optional[int] = ..., completedAt: _Optional[str] = ...) -> None: ...
...
class EnrollmentData(_message.Message):
    __slots__ = ("id", "user_id", "course_id", "status", "progress", "enrolled_at", "completed_at", "created_at", "updated_at", "course", "deleted_at")
    ID_FIELD_NUMBER: _ClassVar[int]
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    COURSE_ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
...
class GetEnrollmentResponse(_message.Message):
    ...
    error: _common_pb2.Error
    def __init__(self, enrollments: _Optional[_Union[EnrollmentDetail, _Mapping]] = ..., error: _Optional[_Union[_common_pb2.Error, _Mapping]] = ...) -> None: ...
